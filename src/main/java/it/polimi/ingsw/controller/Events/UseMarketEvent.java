...
public class UseMarketEvent extends ClientEvent{
    ...
    public UseMarketEvent(char rowOrColumn, int index, PlayerWarehouse newWarehouse, Map<Resource, Integer> discardedRes, int leaderCardSlots1, int leaderCardSlots2) {
